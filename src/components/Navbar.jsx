...
const navItems = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: "Finance Jobs", path: "/services/finance-jobs" },
      { label: "IT Placements", path: "/services/it-placements" },
      { label: "Part-time Jobs", path: "/services/part-time-jobs" },
  ...
  },
  {
    label: "PARTNERS",
    submenu: [
      { label: "Banking Partners", path: "/partners/banks" },
      { label: "Finance Companies", path: "/partners/finance" },
      { label: "IT Companies", path: "/partners/it" },
    ],
  },
  {
    label: "CAREERS",
