...
const servicesData = [
  ...
  },
  {
    ...
    link: "/services/corporate-tieups",
    description:
      "HR solutions for companies looking to hire trained professionals",
    icon: Building2,
    image:
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Comprehensive career services tailored for banking, finance, and IT
            sectors
          </p>
        </motion.div>
